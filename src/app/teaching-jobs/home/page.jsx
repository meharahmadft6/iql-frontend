...
import { getAllHomePostRequirements } from "../../../api/postRequirement.api";
...
const PostRequirementsContent = () => {
  ...
  const fetchAllPosts = async (page = 1, limit = 10) => {
    try {
      setLoading(true);
      const res = await getAllHomePostRequirements(page, limit);
        ...
        <div className="relative container mx-auto px-4 py-16">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Find Home Tutor Jobs
            </h1>
            <p className="text-lg md:text-xl opacity-90 max-w-2xl mx-auto mb-8 leading-relaxed">
              Discover nearby students who need your guidance. Connect with
              learners, teach subjects you excel in, and start tutoring at their
              homes with flexible schedules.
            </p>
            ...
            <div className="flex items-center justify-center gap-4 text-sm">
              <div className="bg-white text-black bg-opacity-20 backdrop-blur-sm rounded-full px-4 py-2 flex items-center gap-2">
                ...
                <span>{totalItems} students required home tutors</span>
              </div>
            </div>
          </div>
        </div>
