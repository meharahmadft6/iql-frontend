...
import { getOnlineTeachers } from "../../../api/teacher.api";
...
const TeachersPage = () => {
  ...
  useEffect(() => {
    const fetchTeachers = async () => {
      try {
        const res = await getOnlineTeachers();
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-12">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              Learn Smarter with Expert Online Tutors
            </h1>
            <p className="text-lg md:text-xl opacity-90 max-w-2xl mx-auto">
              Get personalized, flexible, and high-quality learning from
              certified tutors — anytime, anywhere.
            </p>
          </div>
        </div>
